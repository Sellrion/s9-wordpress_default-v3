            ...
            <?php if(have_posts()): while(have_posts()): ?>
                ...
                <article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>    
                    ...
                    <div class="post-rightside">
                        ...
                        <span class="posttitle"><a href="<?php the_permalink(); ?>" title="Просмотреть новость &quot;<?php the_title(); ?>&quot;" rel="bookmark"><h3><?php the_title(); ?></h3></a></span><?php if(is_sticky()): ?><span class="post-sticky">Важно!</span><?php endif; ?>
                        <br /><br />
